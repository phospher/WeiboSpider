...
from weibo import DefaultWeiboProvider
from weibo import UserModel
from weibo import WeiboModel
...
class DefaultWeiboProviderTest(TestCase):
    ...
    def test_getWeibosWithNoUserRaiseStopIteration(self):
        context = MockContext()
        target = DefaultWeiboProvider(self._weiboAPI, context)
    ...
    def test_getWeibosReturnWeibos(self):
        target = DefaultWeiboProvider(self._weiboAPI, self._context)
